  ...
  return (
    <div>
      ...
      <div className="flex space-x-2 my-4">
        ...
        <StatBlock label="Chars Per Minute" text={charsPerMinute} />
        <StatBlock label="Words Per Minute" text={wordsPerMinute} />
        <StatBlock label="Accuracy" text={Number(accuracy).toFixed(2) + "%"} />
      </div>
      <button
